...
import com.happypill.application.entity.enums.*;
...
public class DataInitialiser implements ApplicationRunner {
    ...
    private final HappypillUserRepository happypillUserRepository;
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        HappypillUser user = HappypillUser.ofSocial(SnowflakeUtil.nextId(), "Test user", Provider.GOOGLE, "Test social sub",
                "testUser@gmail.com", "testUser@gmail.com", Role.USER);

        List<Order> orders = Arrays.asList(
            Order.of(SnowflakeUtil.nextId(), 20000, OrderStatus.COMPLETED, PaymentMethod.CARD, "Test user 1",
                    "010 0000 3000", "TestEmail@test.com", user),
            Order.of(SnowflakeUtil.nextId(), 38000, OrderStatus.PENDING, PaymentMethod.CARD, "Test user 2",
                    "010 0000 3000", "TestEmail@test.com", user)
        );

        List<OrderLine> orderLines = Arrays.asList(
            OrderLine.of(SnowflakeUtil.nextId(), 15000, 3, orders.get(0), productList.get(20)),
            OrderLine.of(SnowflakeUtil.nextId(), 5000, 3, orders.get(0), productList.get(19)),
            OrderLine.of(SnowflakeUtil.nextId(), 20000, 3, orders.get(1), productList.get(20)),
            OrderLine.of(SnowflakeUtil.nextId(), 18000, 3, orders.get(1), productList.get(18))
        );
        ...
        happypillUserRepository.save(user);
